                                  ...
                                  <ul className="sub-menu">
                                    ...
                                    >
                                      <Link to="/" className="gtrackexternal">
                                        ...
                                        Young People (HACC-PYP) Linkages Program
                                      </Link>
                                    </li>
                                  </ul>
                                </div>
                                ...
                                <div className="nav__menu-inner wrap">
                                  <div className="nav__menu-main">
                                    ...
                                    <p className="nav__menu-description">
                                      ...
                                      determine the in-home care that best suits
                                      you at at no cost or obligation.
                                    </p>
                                    <Link
                                      to="/"
                                ...
                                <div className="nav__menu-inner wrap">
                                  <div className="nav__menu-main">
                                    ...
                                    <p className="nav__menu-description">
                                      ...
                                      team of experienced local Care Management
                                      specialists who make life easier every
                                      step of the way on your care journey.
                                    </p>
                                    <Link
                                      to="/"
                                      href="/support/"
                              ...
                              >
                                <div className="nav__menu-inner wrap">
                                  <div className="nav__menu-main">
                                    ...
                                    <p className="nav__menu-description">
                                      We make life easier for you by connecting
                                      you with the care you need to live happily
                                      at home. Our model allows us to draw on a
                                      wide network of vetted care workers, which
                                      offers flexibility and options to best
                                      suit you.
                                    </p>
                                    <Link
                                      to="/"
                ...
                <div className="banner-module__wrapper wrap cf">
                  ...
                  >
                    <h1 className="banner-module__title">
                      ''Chăm sóc bằng cả trái tim - Nâng niu tuổi vàng, trọn vẹn
                      yêu thương."
                    </h1>
                  ...
                  <ul className="tile-grid__row tile-grid__row--simple">
                    ...
                    <li className="tile-grid__tile-wrapper">
                      <div className="tile-grid__tile tile-grid__tile--simple">
                        ...
                        <p className="tile-grid__tile-title">
                          Hỗ trợ bạn tìm hiểu và sử dụng hệ thống chăm sóc người
                          cao tuổi.
                        </p>
                  ...
                  <div className="quote__wrapper quote__wrapper--vertical">
                    ...
                    <div className="quote__box quote__box--pale-blue">
                      <h3 className="quote__opening">
                        ...
                        mọi thay đổi trong chế độ chăm sóc của ba mẹ, đồng thời
                        thấy được sự quan tâm và thấu hiểu của đội ngũ chăm sóc
                        qua những thông tin chi tiết và hình ảnh được chia sẻ.
                      </h3>
                ...
                <div className="wrap cf">
                  <div className="intro__wrapper intro__wrapper--center">
                    <h2 className="intro__title">
                      ...
                      động giúp kết nối người cao tuổi, gia đình họ và nhân viên
                      viện dưỡng lão. Nền tảng này có thể cung cấp các tính năng
                      như theo dõi sức khỏe, đặt lịch hẹn, chia sẻ thông tin và
                        ...
                        <div className="col-left">
                          <div className="col-left__body">
                            <p className="tabbed-carousel__paragraph--lead">
                              ...
                              diện, mang đến sự an tâm cho người lớn tuổi và gia
                              đình. Chúng tôi cung cấp dịch vụ chăm sóc cá nhân,
                              y tế, tinh thần và môi trường sống ấm cúng, tiện
                              nghi. Người nhà dễ dàng theo dõi tình hình sức
                              khỏe người thân qua ứng dụng, giúp kết nối mọi lúc
                              mọi nơi.
                            </p>
                ...
                <div className="wrap cf">
                  <div className="quote__wrapper quote__wrapper--vertical">
                    ...
                    <div className="quote__box quote__box--green">
                      <h3 className="quote__opening">
                        Tôi rất hài lòng với cách Care Connect chăm sóc cho gia
                        đình tôi
                      </h3>
                          ...
                          >
                            ...
                            <div className="card__content">
                              ...
                              <p className="card__excerpt" id="card-desc-9019">
                                Thời tiết lạnh và ẩm ướt thường khiến chúng ta ở
                                nhà, điều này có thể gây ra sự cô lập và cô đơn
                                cho một số người. Việc duy trì kết nối với người
                                khác là vô cùng quan trọng ở mọi lứa tuổi, đặc
                                biệt khi chúng ta lớn tuổi hơn.
                              </p>
                          ...
                          >
                            ...
                            <div className="card__content">
                              ...
                              <p className="card__excerpt" id="card-desc-8996">
                                Đến lúc thưởng thức một tác phẩm kinh điển! Tiểu
                                thuyết "Câu Chuyện Người Dì" của Patrick White.
                              </p>
                              <div className="card__actions card__actions--no-border">
                                <p className="card__fake-link">
                                  Đọc thêm
            ...
            >
              <div className="wrap cf">
                <section className="contact-cta__text-wrapper">
                  ...
                  <p>
                    Để biết thêm thông tin về nhiều cách mà Care Connect có thể
                    giúp bạn và những người thân yêu của bạn tiếp tục sống an
                    toàn và hạnh phúc tại viện dưỡng lão, hãy liên hệ ngay hôm
                    nay để được tư vấn thân thiện, chuyên nghiệp.
                  </p>
                ...
                <div className="wrap cf">
                  <div id="footer-top">
                    ...
                    >
                      ...
                      >
                        <ul id="menu-social-menu" className="nav social-nav cf">
                          <li
                            id="menu-item-166"
